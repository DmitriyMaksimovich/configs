...
(custom-set-faces
 ...
 '(evil-ex-lazy-highlight ((t (:background "sea green" :foreground "black"))))
 '(flycheck-warning ((t (:underline nil))))
 '(org-agenda-date ((t (:foreground "#7590db"))))
